...
class HighlightAdd(OperatorBatoms):
    ...
    name: StringProperty(
        name="name", default="0", description="Name of highlight to be added"
    )
...
class HighlightRemove(OperatorBatoms):
    ...
    name: StringProperty(
        name="name", default="1-1-1", description="Name of highlight to be removed"
    )

    all: BoolProperty(name="all", default=False, description="Remove all highlights")
...
class HighlightDraw(OperatorBatoms):
    ...
    name: StringProperty(
        name="name", default="ALL", description="Name of highlight to be drawed"
    )
