...
class CavityAdd(OperatorBatoms):
    ...
    name: StringProperty(
        name="name", default="0", description="Name of cavity to be added"
    )
...
class CavityRemove(OperatorBatoms):
    ...
    name: StringProperty(
        name="name", default="1-1-1", description="Name of cavity to be removed"
    )

    all: BoolProperty(name="all", default=False, description="Remove all cavitys")
...
class CavityDraw(OperatorBatoms):
    ...
    name: StringProperty(
        name="name", default="ALL", description="Name of cavity to be drawed"
    )
