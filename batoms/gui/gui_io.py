...
class BatomsPropertiesIO(bpy.types.PropertyGroup):
    pubchem_cid: StringProperty(
        name="pubchem_cid", default="31423", description="pubchem_cid"
    )

    mp_key: StringProperty(name="mp_Key", default="", description="mp_key")

    mp_id: StringProperty(name="mp_ID", default="mp-2815", description="mp_id")

    rscb_name: StringProperty(name="rscb_name", default="1ema", description="rscb_name")
