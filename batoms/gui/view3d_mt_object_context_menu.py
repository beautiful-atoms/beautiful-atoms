...
class VIEW3D_MT_object_context_batoms(Menu):
    ...
    def draw(self, _context):
        ...
        layout.operator_context = "INVOKE_REGION_WIN"
        layout.menu(
            "VIEW3D_MT_object_context_batoms_model_style",
            text="Model Style",
            icon="LAYER_ACTIVE",
        )
        layout.menu(
            "VIEW3D_MT_object_context_batoms_color_style",
            text="Color Style",
            icon="LAYER_ACTIVE",
        )
        layout.menu(
            "VIEW3D_MT_object_context_batoms_radius_style",
            text="Radius Style",
            icon="LAYER_ACTIVE",
        )
        layout.menu(
            "VIEW3D_MT_object_context_batoms_label", text="Label", icon="LAYER_ACTIVE"
        )
        ...
        layout.operator(
            "batoms.delete_selected_batoms", text="Delete", icon="FORCE_LENNARDJONES"
        )
        layout.operator(
            "batoms.auto_build_species", text="Auto build species", icon="LAYER_ACTIVE"
        )
...
class VIEW3D_MT_object_context_bonds(Menu):
    ...
    def draw(self, _context):
        ...
        layout.operator_context = "INVOKE_REGION_WIN"
        layout.operator(
            "bond.show_hydrogen_bond", text="Show hydrogen bond", icon="LAYER_ACTIVE"
        )
        layout.operator(
            "bond.show_search", text="Show atoms by searching bond", icon="LAYER_ACTIVE"
        )
        layout.operator(
            "bond.bond_order_auto_set", text="Auto set bond order", icon="LAYER_ACTIVE"
        )
