...
class BuildNanoribbon(Operator):
    ...
    label: StringProperty(name="Label", default="graphene", description="Label")
    ...
    magnetic: BoolProperty(
        name="Magnetic", default=False, description="Make the edges magnetic."
    )
    ...
    main_element: StringProperty(
        name="Main_element", default="C", description="Main_element"
    )

    saturate_element: StringProperty(
        name="Saturate_element", default="H", description="saturate_element"
    )
