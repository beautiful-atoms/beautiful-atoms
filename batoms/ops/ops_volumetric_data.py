...
class VolumetricDataAdd(OperatorBatoms, ImportHelper):
    ...
    name: StringProperty(name="name", default="", description="name to be added")
...
class VolumetricDataRemove(OperatorBatoms):
    ...
    name: StringProperty(name="name", default="C", description="name to be removed")

    all: BoolProperty(name="all", default=False, description="Remove all data")
...
class VolumetricDataCreate(OperatorBatoms):
    ...
    name: StringProperty(
        name="name", default="", description="Volumetric data to be Created."
    )
