...
class Protein(bpy.types.PropertyGroup):
    ...
    turn_ui_list_index: IntProperty(name="turn_ui_list_index", default=0)
    sheet_ui_list_index: IntProperty(name="sheet_ui_list_index", default=0)
    helix_ui_list_index: IntProperty(name="helix_ui_list_index", default=0)

    # colleciton properties
    settings_turn: CollectionProperty(name="settings_turn", type=TurnSetting)
    settings_sheet: CollectionProperty(name="settings_sheet", type=SheetSetting)
    settings_helix: CollectionProperty(name="settings_helix", type=HelixSetting)
