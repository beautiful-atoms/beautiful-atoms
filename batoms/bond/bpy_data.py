...
class BondSetting(Base):
    ...
    color1: FloatVectorProperty(
        name="color1", size=4, subtype="COLOR", min=0, max=1, default=(0, 0.2, 0.8, 1)
    )
    color2: FloatVectorProperty(
        name="color2", size=4, subtype="COLOR", min=0, max=1, default=(0.6, 0.2, 0, 1)
    )
...
class Bond(Base):
    ...
    # collection
    settings: CollectionProperty(name="bondsetting", type=BondSetting)
