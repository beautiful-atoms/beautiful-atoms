...
class Bond(BaseCollection, ObjectGN):
    ...
    def build_geometry_node(self):
        ...
        SpeciesAtIndexs = []
        for i in range(2):
            AtomsIndexAttribute = get_node_by_name(nodes,
            ...
            output_socket = get_socket_by_identifier(AtomsIndexAttribute, "Attribute_Int", type="outputs")
    ...
    def build_bond_mesh(self):
        ...
        GroupOutput = nodes[1]
        # link the input to parent node
        parent_tree.links.new(parent_tree.nodes[0].outputs['Geometry'],
        ...
        for i in range(4):
            ...
            links.new(PositionBatoms.outputs[0],
                                    socket)
        ...
        MeshToPoints = get_node_by_name(nodes,
        ...
        VectorLength = get_node_by_name(nodes,
                                         '%s_VectorLength' % self.label,
                                         'ShaderNodeVectorMath')
        VectorLength.operation = 'LENGTH'
        VectorCross0 = get_node_by_name(nodes,
    ...
    def add_bond_pair_node(self, sp, order=None, style=None):
        ...
        ObjectInstancer = get_node_by_name(nodes,
                                            'ObjectInfo_%s' % name,
        ...
        links.new(LessBondLength.outputs[0],
        ...
        #
        links.new(ObjectInstancer.outputs['Geometry'],
